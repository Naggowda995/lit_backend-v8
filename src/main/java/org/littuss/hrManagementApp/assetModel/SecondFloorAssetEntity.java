...
@Entity
@Table(name="secondFloorAssetRegister")
...
public class SecondFloorAssetEntity {
	...
	public SecondFloorAssetEntity( String normalChairs, String wheelChairs, String acRemotes, String fanRemotes,
	...
	public String toString() {
		return "SecondFloorAssetEntity [id=" + id + ", normalChairs=" + normalChairs + ", wheelChairs=" + wheelChairs
				...
				+ chargers + ", bags=" + bags + ", fans=" + fans + ", dustbins=" + dustbins + ", tables=" + tables +"activeStatus,"+activeStatus
				+ "]";
	}
